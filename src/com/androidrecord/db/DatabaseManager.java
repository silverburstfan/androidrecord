...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    private DatabaseManager(Context context, String dbName, Migrations migrations) {
        super(context, underscorize(dbName), null, migrations.latest());
        this.migrations = migrations;
        this.context = context;
    }

    public DatabaseManager(Context context, String dbName) {
        this(context, dbName, new Migrations(context.getAssets()));
    }
